        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            <div style={{ display: 'flex', backgroundColor: '#f8fafc', padding: '6px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--color-border)' }}>
              <Link to="/admin/login" style={{ flex: 1, textAlign: 'center', padding: '0.625rem', borderRadius: 'var(--radius-md)', textDecoration: 'none', fontWeight: 600, color: 'var(--color-text-muted)', backgroundColor: 'transparent', transition: 'all 0.2s' }}>
                Admin
              </Link>
              <Link to="/manager/login" style={{ flex: 1, textAlign: 'center', padding: '0.625rem', borderRadius: 'var(--radius-md)', textDecoration: 'none', fontWeight: 600, color: '#fff', backgroundColor: '#2563eb', boxShadow: '0 2px 4px rgba(37,99,235,0.2)', transition: 'all 0.2s' }}>
                Manager
              </Link>
            </div>
          </div>
